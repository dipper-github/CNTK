...
namespace CNTK
{
    ...
    public:
        ...
        {
            return m_totalNumberOfSamplesSeen;
        }
    ...
    protected:
        ...
        ElementType GetCurrentTrainingParameterValue(const TrainingParameterSchedule<ElementType>& schedule) const
        {
            ...
            {
                return schedule[m_totalNumberOfSamplesSeen];
            }
        }
    ...
    public:
        ...
        // learning has stopped for all of the parameters associated with this learner
        //
        CNTK_API virtual bool Update(std::unordered_map<Parameter, NDArrayViewPtr>& gradientValues, MinibatchInfo& trainingSampleCount) = 0;
    ...
    private:
        ...
        void Save(const std::wstring& modelFilePath, const Dictionary& learnerState, const Dictionary& externalState);
